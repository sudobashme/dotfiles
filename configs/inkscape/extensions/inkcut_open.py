...
# Patched for macOS Inkscape.app (absolute inkcut + PATH)
import os as _os
_os.environ['PATH'] = '/Users/shawnlime/.pyenv/versions/3.12.7/bin' + _os.pathsep + _os.environ.get('PATH', '')
...
class InkscapeInkcutPlugin(inkex.Effect):
    def effect(self):
        ...
        if DEBUG:
            ...
            cmd = ['/Users/shawnlime/.pyenv/versions/3.12.7/bin/inkcut']
